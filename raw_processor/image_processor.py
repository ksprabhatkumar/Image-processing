...
def process_raw_to_png(raw_image_path, output_dir):
    ...
    # --- CHANGE 1: The output filename now ends in .jpg ---
    ...
    try:
        ...
        # --- CHANGE 2: Save as JPG with a quality setting ---
        # The 'quality' parameter (0-100) controls the file size vs. quality trade-off.
        # 95 is a standard value for high-quality JPGs.
        # imageio automatically uses the JPEG format because the filename ends in .jpg.
